...
recognition.onresult = (event) => {
  ...
  let comands = {
      ...
      'привет джарвис':()=>{
        ...
        voice('Да сэр')
      },'послушай джарвис||эй джарвис||послушать джарвис':()=>{
          console.log('Джарвис: чего тебе')
      voice('чего тебе')
      ...
      'как ты||как ты джарвис||как дела||как дела джарвис': function() {
        console.log('Джарвис:отлично сэр, чем желаете заняться')
        voice('отлично сэр, чем желаете заняться?')
      },
